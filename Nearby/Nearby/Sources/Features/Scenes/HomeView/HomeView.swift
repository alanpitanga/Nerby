...
class HomeView: UIView {
    ...
    private func updateButtonSelection(button: UIButton) {
        if let previusButton = selectedButton {
            previusButton.backgroundColor = Colors.gray100
            previusButton.setTitleColor(Colors.gray600, for: .normal)
            previusButton.tintColor = Colors.gray600
        }
