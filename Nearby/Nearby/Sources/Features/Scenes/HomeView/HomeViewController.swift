...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        homeViewModel.fecthInitialData { [ weak self] categories in
    ...
    private func addAnnotationsToMap() {
        ...
        if let firstAnnotations = annotations.first {
            homeView.mapView.setRegion(MKCoordinateRegion(center: firstAnnotations.coordinate, span: MKCoordinateSpan(latitudeDelta: 0.05, longitudeDelta: 0.05)), animated: true)
        }
    }
